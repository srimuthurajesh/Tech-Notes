...
```
<style>body{background-color:#1e1e1e;color:#d4d4d4}h1,h2,h3,h4,h5,h6{color:#e6e6e6}p{color:#d4d4d4}a{color:#4ec4e4}pre{background-color:#2b2b2b;color:#d4d4d4;border:1px solid #3a3a3a;padding:10px;overflow-x:auto}code{background-color:#2b2b2b;color:#d4d4d4;padding:2px 4px;border-radius:4px}.markdown-body table tr,.markdown-body table tr:nth-child(2n){background-color:#333}.highlight{background-color:#333}.highlight .highlight{background-color:#555}ul,ol{color:#d4d4d4}blockquote{background-color:#333;color:#d4d4d4;padding:10px;margin:0}hr{border-color:#444}table{border-collapse:collapse;width:100%}th,td{border:1px solid #444;padding:8px}th{background-color:#2b2b2b;color:#d4d4d4}img{filter:invert(1)}</style>